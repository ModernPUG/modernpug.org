...
@section('content')
    ...
    <div class="hero-area height-400 bg-img background-overlay"
         style="background-image: url(/img/check-class-desk-7103.jpg);">
                    ...
                    <div class="contact-form">
                        ...
                        <form action="{{ route('blogs.update',['id'=>$blog->id]) }}" method="post">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="group">
                                        <input type="url" name="feed_url" id="feed_url" value="{{ old('feed_url')??$blog->feed_url }}"
                                               required>
                                ...
                                <div class="col-12">
                                    <div class="group">
                                        <textarea name="comment" id="comment">{{ old('comment')??$blog->comment }}</textarea>
                                        <span class="highlight"></span>
                                        <span class="bar"></span>
                                ...
                                <div class="col-12 mb-30">
                                    <button type="submit" class="btn world-btn">update</button>
                                </div>
                                <div class="col-12">
