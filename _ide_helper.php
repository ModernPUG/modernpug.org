 ...
 * Generated for Laravel 5.7.19 on 2018-12-30 16:41:41.
 *
...
namespace Pressutto\LaravelSlack\Facades { 
    ...
    class Slack {
        ...
        {
            return \Pressutto\LaravelSlack\Slack::to($recipient);
        }
        ...
        {
            \Pressutto\LaravelSlack\Slack::send($message);
        }
        ...
        {
            return \Pressutto\LaravelSlack\Testing\SlackFake::sentMessages();
        }
        ...
        {
            return \Pressutto\LaravelSlack\Testing\SlackFake::assertSent($callback, $count, $strict);
        }
        ...
        {
            return \Pressutto\LaravelSlack\Testing\SlackFake::assertSentCount($count);
        }
